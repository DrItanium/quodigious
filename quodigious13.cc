...
int main(int argc, char* argv[]) {
	...
	if (argc > 1) {
		...
		auto p0 = makeSuperWorker<2, digitCount, dimensionCount, secondaryDimensionCount>(primaryDataCache, secondaryDataCache, std::launch::deferred);
		auto p1 = makeSuperWorker<3, digitCount, dimensionCount, secondaryDimensionCount>(primaryDataCache, secondaryDataCache, std::launch::deferred);
		auto p2 = makeSuperWorker<4, digitCount, dimensionCount, secondaryDimensionCount>(primaryDataCache, secondaryDataCache, std::launch::deferred);
		auto p3 = makeSuperWorker<6, digitCount, dimensionCount, secondaryDimensionCount>(primaryDataCache, secondaryDataCache, std::launch::deferred);
		auto p4 = makeSuperWorker<7, digitCount, dimensionCount, secondaryDimensionCount>(primaryDataCache, secondaryDataCache, std::launch::deferred);
		auto p5 = makeSuperWorker<8, digitCount, dimensionCount, secondaryDimensionCount>(primaryDataCache, secondaryDataCache, std::launch::deferred);
