...
#define WORKUNIT_ID 0
    ...
    constexpr auto innerThreadId = WORKUNIT_ID;
    static_assert(innerThreadId >= 0 && innerThreadId < numElements<fallOver>, "Illegal workunit id!");
    constexpr auto start = workUnitCount * innerThreadId;
    constexpr auto stop0 = oneSeventhWorkUnit + start;
    constexpr auto stop1 = oneSeventhWorkUnit + stop0;
    constexpr auto stop2 = oneSeventhWorkUnit + stop1;
    constexpr auto stop3 = oneSeventhWorkUnit + stop2;
    constexpr auto stop4 = oneSeventhWorkUnit + stop3;
    constexpr auto stop5 = oneSeventhWorkUnit + stop4;
    constexpr auto stop6 = oneSeventhWorkUnit + stop5;
    constexpr auto stop = workUnitCount * (innerThreadId + 1);
    static_assert(stop == stop6, "Thread Range Mismatch!");
    ...
    std::cout << b0.get() << b1.get() << b2.get() << b3.get() << b4.get() << b5.get() << b6.get();
    return 0;
}
