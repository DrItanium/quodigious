...
constexpr auto digitCount = 17;
constexpr auto threadCount = 35;
...
int main(int argc, char* argv[]) {
	if (!loadDataCache<1>("cache.bin", primaryDataCache, primaryDataCacheSize) || !loadDataCache<9>("cache6.bin", secondaryDataCache, secondaryDataCacheSize)) {
        return 1;
    }
